...
import { FlowChartMenu, SuanziMenu } from './LeftMenuItems.js'
    ...
    methods: {
        init() {
            const lf = new LogicFlow({
                ...
                plugins: [Menu, BpmnElement, FlowChartMenu, SuanziMenu, SelectionSelect, Control, MiniMap, Snapshot],
                background: {
                    color: '#2b364a' // 网格背景颜色
                },
                keyboard: {
            ...
            // 设置算子面板
            lf.extension.suanziMenu.setPatternItems(suanziItemList)


            // 设置节点面板, 设置框选回调
            flowChartItemList[0].callback = () => {
                        lf.openSelectionSelect();
                        lf.once("selection:selected", () => {
                            lf.closeSelectionSelect();
                        });
            },
            lf.extension.flowChartMenu.setPatternItems(flowChartItemList)
